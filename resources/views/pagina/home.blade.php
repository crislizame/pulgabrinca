                ...
                <div class="tg-ads">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-02.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-03.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-04.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-05.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-06.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-07.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-08.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                ...
                <div class="tg-ads tg-adsvtwo">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-09.jpg")}}" alt="image description"></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-10.jpg")}}" alt="image description"></a>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                                    <li><a href="javascript:void(0);">Furniture</a></li>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-11.jpg")}}" alt="image description"></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <span class="tg-themetag tg-featuretag">featured</span>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-12.jpg")}}" alt="image description"></a>
                                <span class="tg-photocount">See 18 Photos</span>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-13.jpg")}}" alt="image description"></a>
                            </figure>
                            <div class="tg-adcontent">
                                <ul class="tg-productcagegories">
                                    <li><a href="javascript:void(0);">Furniture</a></li>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="tg-ad tg-verifiedad">
                            <figure>
                                <a href="javascript:void(0);"><img src="{{asset("assets/images/ads/img-14.jpg")}}" alt="image description"></a>
...
{{--                                <a href="javascript:void(0);"><img src="{{asset("assets/images/post/img-01.jpg")}}" alt="image description"></a>--}}
{{--                            </figure>--}}
...
{{--                        <div class="tg-post">--}}
{{--                            <figure>--}}
{{--                                <a href="javascript:void(0);"><img src="{{asset("assets/images/post/img-02.jpg")}}" alt="image description"></a>--}}
{{--                            </figure>--}}
{{--                            <div class="tg-postcontent">--}}
{{--                                <ul class="tg-postcategories">--}}
...
{{--                            <figure>--}}
{{--                                <span class="tg-themetag tg-bookmarktag"><i class="icon-bookmark"></i></span>--}}
{{--                                <a href="javascript:void(0);"><img src="{{asset("assets/images/post/img-03.jpg")}}" alt="image description"></a>--}}
{{--                            </figure>--}}
{{--                            <div class="tg-postcontent">--}}
{{--                                <ul class="tg-postcategories">--}}
{{--                                    <li><a href="javascript:void(0);">Trade</a></li>--}}
...
{{--                                <figure><img src="{{asset("assets/images/testimonials/img-01.jpg")}}" alt="image description"></figure>--}}
...
{{--                        <div class="item">--}}
{{--                            <div class="tg-testimonial">--}}
{{--                                <figure><img src="{{asset("assets/images/testimonials/img-02.jpg")}}" alt="image description"></figure>--}}
{{--                                <div class="tg-contentbox">--}}
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div id="tg-brandsslider" class="tg-brands tg-brandsslider owl-carousel">
                        <figure class="item"><img src="{{asset("assets/images/brands/img-01.png")}}" alt="image description"></figure>
                        <figure class="item"><img src="{{asset("assets/images/brands/img-02.png")}}" alt="image description"></figure>
                        <figure class="item"><img src="{{asset("assets/images/brands/img-03.png")}}" alt="image description"></figure>
                        <figure class="item"><img src="{{asset("assets/images/brands/img-04.png")}}" alt="image description"></figure>
                    </div>
                </div>
            </div>
        </div>
