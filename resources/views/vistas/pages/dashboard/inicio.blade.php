        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                <div class="tg-dashboardbox tg-statistic">
                    <figure><img src="{{asset('assets/images/icons/img-32.png')}}" alt="image description"></figure>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                <div class="tg-dashboardbox tg-statistic">
                    <figure><img src="{{asset('assets/images/icons/img-33.png')}}" alt="image description"></figure>
                    <div class="tg-contentbox">
                        <h2>06</h2>
                        <h3>Featured Ads</h3>
                        <a class="tg-btnviewdetail fa fa-angle-right" href="javascript:void(0);">View Detail</a>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                <div class="tg-dashboardbox tg-statistic">
                    <figure><img src="{{asset('assets/images/icons/img-34.png')}}" alt="image description"></figure>
                    <div class="tg-contentbox">
                        <h2>04</h2>
                        <h3>Inactive Ads</h3>
                        <a class="tg-btnviewdetail fa fa-angle-right" href="javascript:void(0);">View Detail</a>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                <div class="tg-dashboardbox tg-statistic">
                    ...
                    <figure><img src="{{asset('assets/images/icons/img-35.png')}}" alt="image description"></figure>
                    <div class="tg-contentbox">
                        <h2>45706</h2>
                ...
                <div class="tg-dashboardbox">
                    ...
                    <div class="tg-dashboardholder tg-approvedads tg-verticalscrollbar tg-dashboardscrollbar">
                        <ul class="tg-approvedads">
                            <li>
                                <figure><a href="javascript:void(0);"><img src="{{asset('assets/images/ads/thumbnail/img-01.jpg')}}')}}" alt="image description"></a></figure>
                            ...
                            <li>
                                <figure><a href="javascript:void(0);"><img src="{{asset('assets/images/ads/thumbnail/img-02.jpg')}}')}}" alt="image description"></a></figure>
                                <div class="tg-adcontent">
                                    <span class="tg-adverified">Verified Ad</span>
                            ...
                            <li>
                                <figure><a href="javascript:void(0);"><img src="{{asset('assets/images/ads/thumbnail/img-03.jpg')}}')}}" alt="image description"></a></figure>
                                <div class="tg-adcontent">
                                    <span class="tg-adverified">Verified Ad</span>
                            ...
                            <li>
                                <figure><a href="javascript:void(0);"><img src="{{asset('assets/images/ads/thumbnail/img-04.jpg')}}')}}" alt="image description"></a></figure>
                                <div class="tg-adcontent">
                                    <span class="tg-adverified">Verified Ad</span>
                            ...
                            <li>
                                <div class="tg-verticalscrollbar tg-dashboardscrollbar">
                                    <div class="tg-ad tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-01.jpg')}}" alt="image description"></figure>
                                        <h3>Brand new lenovo laptop i5 for sale</h3>
                                    </div>
                                    <div class="tg-ad tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-02.jpg')}}" alt="image description"></figure>
                                        <h3>Samsung galaxy s5 for sale</h3>
                                    </div>
                                    <div class="tg-ad tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-03.jpg')}}" alt="image description"></figure>
                                        <h3>Honda civic for sale urgent</h3>
                                    </div>
                                    <div class="tg-ad">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-04.jpg')}}" alt="image description"></figure>
                                        <h3>18 - 55 used macro lense for sale</h3>
                                    </div>
                                    <div class="tg-ad">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-05.jpg')}}" alt="image description"></figure>
                                        <h3>Eye Catching Parrot for sale urgent</h3>
                                    </div>
                                    <div class="tg-ad">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-06.jpg')}}" alt="image description"></figure>
                                        <h3>Xtreme core processor with cooling gel</h3>
                                    </div>
                                    <div class="tg-ad">
                                        <figure><img src="{{asset('assets/images/ads/thumbnail/img-07.jpg')}}" alt="image description"></figure>
                            ...
                            <li>
                                <div class="tg-offerers tg-verticalscrollbar tg-dashboardscrollbar">
                                    <div class="tg-offerer tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/author/img-08.jpg')}}" alt="image description"></figure>
                                        <h3>Antoine Hibdon</h3>
                                    </div>
                                    <div class="tg-offerer tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/author/img-09.jpg')}}" alt="image description"></figure>
                                        <h3>Lissa Hier</h3>
                                    </div>
                                    <div class="tg-offerer tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/author/img-10.jpg')}}" alt="image description"></figure>
                                        <h3>Preston Kintner</h3>
                                    </div>
                                    <div class="tg-offerer tg-dotnotification">
                                        <figure><img src="{{asset('assets/images/author/img-11.jpg')}}" alt="image description"></figure>
                                        <h3>Adolph Varley</h3>
                                    </div>
                                    <div class="tg-offerer">
                                        <figure><img src="{{asset('assets/images/author/img-12.jpg')}}" alt="image description"></figure>
                                        <h3>Tosha Tinney</h3>
                                    </div>
                                    <div class="tg-offerer">
                                        <figure><img src="{{asset('assets/images/author/img-13.jpg')}}" alt="image description"></figure>
                                        <h3>Lynwood Krob</h3>
                                    </div>
                                    <div class="tg-offerer">
                                        <figure><img src="{{asset('assets/images/author/img-14.jpg')}}" alt="image description"></figure>
                                        <h3>Adan Toney</h3>
                                    </div>
                                    <div class="tg-offerer">
                                        <figure><img src="{{asset('assets/images/author/img-15.jpg')}}" alt="image description"></figure>
                                        <h3>Susanne Foran</h3>
                                    </div>
                                    <div class="tg-offerer">
                                        <figure><img src="{{asset('assets/images/author/img-08.jpg')}}" alt="image description"></figure>
                                ...
                                <div class="tg-chatarea">
                                    <div class="tg-messages tg-verticalscrollbar tg-dashboardscrollbar">
                                        <div class="tg-offerermessage">
                                            <figure><img src="{{asset('assets/images/author/img-16.jpg')}}" alt="image description"></figure>
                                        ...
                                        <div class="tg-memessage tg-readmessage">
                                            <figure><img src="{{asset('assets/images/author/img-17.jpg')}}" alt="image description"></figure>
                                            <div class="tg-description">
